    ...
    if (window.Windows) {
        ...
        var FWA = window.FWA = new function () {
            ...
            ****************************************************************************/
            ...
            this.JumpList.__proto__.configure = function () {
                var that = this;
            ...
            ****************************************************************************/
            ...
            this.Page.__proto__.injectJS = function (options) {
                ...
                if (!_options.customJS || _options.customJS === "")
                    return;
            ...
            switch (args.kind) {
                case activation.ActivationKind.launch:
                    ...
                    if (args.detail.previousExecutionState !== activation.ApplicationExecutionState.terminated) {
                        ...
                        FWA.JumpList.configure();

                        if (FWA.LiveTiles.options.tileUrl && FWA.LiveTiles.options.tileUrl != "" && FWA.LiveTiles.options.enabled) {
